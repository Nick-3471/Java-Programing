...
The method needs to return a value of type int that represents the number of buckets that Bob needs to buy before going to work. To calculate the bucket count, 
...
This method needs to return a value of type int that represents the number of buckets that Bob needs to buy before going to work. To calculate the bucket count, 
    efer to the notes below.
...
public class PaintJob {
    public static void main(String[] args) {
       System.out.println(getBucketCount(9, 8, 2.5, 1) + " Buckets Needed"); 
    }
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        double finalBucketsNeeded = Math.ceil(totalBucketsNeeded-extraBuckets);

        return (int)finalBucketsNeeded;
    }
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket) {
        ...
        double area = width*height;
        double totalBucketsNeeded = area/areaPerBucket;
        double finalBucketsNeeded = Math.ceil(totalBucketsNeeded);
